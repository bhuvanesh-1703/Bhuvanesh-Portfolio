...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    const PUBLIC_KEY = "say_hello";

    emailjs.sendForm(SERVICE_ID, TEMPLATE_ID, e.target, PUBLIC_KEY)
      .then(() => {
        Swal.fire({
          title: 'Message Sent!',
          text: 'I have received your email and will respond shortly.',
          icon: 'success',
            ...
            <div className="contact__form-card glass-card">
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-group mb-3">
                  ...
                  <input type="email" name="user_email" className="form-input" placeholder="you@example.com" required />
                </div>
